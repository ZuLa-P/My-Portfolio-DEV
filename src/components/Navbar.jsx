  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <Link
          to="/"
          className={`text-base sm:text-xl font-bold transition ${
            isDark
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={toggleLang}
            className={`px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-bold rounded-full border transition ${
              isDark
          ...
          <button
            onClick={toggleTheme}
            className={`w-7 h-7 sm:w-9 sm:h-9 rounded-full flex items-center justify-center transition ${
              isDark
